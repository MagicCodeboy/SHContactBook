...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 0)
    {
        [[SHContactManager sharedInstance] createNewContactWithPhoneNum:self.phoneNumBtn.titleLabel.text controller:self];
    }
    else if (buttonIndex == 1)
    {
        [[SHContactManager sharedInstance] addToExistingContactsWithPhoneNum:self.phoneNumBtn.titleLabel.text controller:self];
    }
}
